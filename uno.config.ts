...
export default defineConfig({
  ...
  shortcuts: [
    ...
    ['button', 'px-6 py-3 rounded-[50px] border-none w-90% m-auto inline-block bg-primary text-white  outline-hidden  disabled:cursor-default disabled:bg-gray-600 disabled:opacity-50 shadow-[0px_21px_38px_0px_rgba(56,117,198,0.32)]'],
    // flex布局
